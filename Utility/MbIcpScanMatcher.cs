...
namespace ScanMatchers.ScanMatcher
{
    public class MbIcpScanMatcher : IScanMatchers
    {
        ...
        public static double F = 0.93;// asl 0.95
        public static double LMET = 3;
        public static double Br = 0.03; //radial window //0.3
        public static double Bw = 0.0523333333; //angular window //0.523333333
        public static double MaxDistInter = 0.02; // asl 0.2
        public static double AsocError = 0.1; // asl 0.1

        public static double Min_Error = 0.00001; // 0.0001
        public static int IterSmoothConv = 2; //2
